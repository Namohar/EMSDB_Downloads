    ...
    public partial class Form1 : Form
    {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            else
            {
                ...
                //TimeSpan GlobalRptStart = new TimeSpan(20, 00, 0);// New TimeSpan(6, 45, 0)
                //TimeSpan GlobalRptEnd = new TimeSpan(20, 01, 0);
                TimeSpan GlobalRptStart = new TimeSpan(23, 30, 0);// New TimeSpan(6, 45, 0)
                TimeSpan GlobalRptEnd = new TimeSpan(23, 31, 0);
        ...
        private void WeeklyReport()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                using (MemoryStream memoryStream = new MemoryStream())
                {
                    ...
                    message1.Attachments.Add(new Attachment(new MemoryStream(bytes), "EMSDBWeeklyReport.xlsx"));


                    message1.Subject = "Global Support EMS Manual Invoice Processing EOB Report for    " + To.ToString("yyyy-MM-dd");
                    ...
                    sb.AppendLine("");
                    sb.AppendLine(string.Format("<br /> Global Support EMS Manual Invoice Processing EOB Report for   " + From.ToString("yyyy-MM-dd") + " to " + To.ToString("yyyy-MM-dd")));
                    sb.AppendLine("<br />");
                    sb.AppendLine("<br />");
        ...
        protected void SummaryReport()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                using (MemoryStream memoryStream = new MemoryStream())
                {
                    ...
                    message1.CC.Add(("namohar.m@tangoe.com"));
                    System.Net.Mail.Attachment attachment;
                    //  attachment = new System.Net.Mail.Attachment("C:\\Report\\EMSDB_SummaryReport.xls");
                    message1.Attachments.Add(new Attachment(new MemoryStream(bytes), "EMSDBSummaryReport.xlsx"));
                    // message1.Attachments.Add(attachment);
                    StringBuilder sb = new StringBuilder();
                    getDelayHTML_SummaryReport(dt);
                    sb.AppendLine("<h3>Hi Team,<h3>");
                    sb.AppendLine(string.Format("<br /> EMSDB Summary Report for : " + DateTime.Now.AddDays(-1).ToString("yyyy-MM-dd")));
                    sb.AppendLine("");
                    sb.AppendLine("");
                    sb.AppendLine("<br />");
                    sb.AppendLine(myBuilderSummaryReport.ToString());
                    sb.AppendLine("");
                    sb.AppendLine("<br />");
                    sb.AppendLine(string.Format("Please review and let us know if you have any clarifications.<br /><br /><P> Note : This is system generated mail. please send mail to namohar.m@tangoe.com and tangoe-devops@tangoe.com if you have any issues.</p><br /><br /> Thank You.<br />EMSDB Team<br /> "));
                    sb.AppendLine("");

                    message1.Subject = "EMSDB Summary Report";
                    message1.Body = sb.ToString();
                    //   message1.Body = string.Format("<h3>Hi Team,<h3>" +
                    //"<br /> EMSDB Summary Report for " + DateTime.Now.AddDays(-1).ToString("M/d/yyyy") + ". Please review and let us know if you have any clarifications.<br /><br />Note : This is System Generated mail. please send mail to namohar.m@tangoe.com if you have any issues.<br /><br /> Thank You.<br />EMSDB Team<br /> ");
        ...
        private string getDelayHTML_SummaryReport(DataTable dt)
        {

            myBuilderSummaryReport = new StringBuilder();

            myBuilderSummaryReport.Append("<table border='1' cellpadding='5' cellspacing='0' ");
            myBuilderSummaryReport.Append("style='border: solid 1px Silver; font-size: x-small;'>");

            myBuilderSummaryReport.Append("<tr align='left' valign='top'>");
            foreach (DataColumn myColumn in dt.Columns)
            {
                myBuilderSummaryReport.Append("<td align='left' valign='top' bgcolor='#3F88F6'>");
                myBuilderSummaryReport.Append("<B />" + myColumn.ColumnName);
                myBuilderSummaryReport.Append("</td>");
            }
            myBuilderSummaryReport.Append("</tr>");
            ...
            foreach (DataRow myRow in dt.Rows)
            {
                if (myRow.ItemArray.Contains("Total"))
                {
                    ...
                    foreach (DataColumn myColumn in dt.Columns)
                    {
                        myBuilderSummaryReport.Append("<td align='left' valign='top' bgcolor='#FFFF00'>");
                        myBuilderSummaryReport.Append("<B />" + myRow[myColumn.ColumnName].ToString());
                        myBuilderSummaryReport.Append("</td>");
                    }
                    myBuilderSummaryReport.Append("</tr>");
                }
                else
                {
                    ...
                    foreach (DataColumn myColumn in dt.Columns)
                    {
                        myBuilderSummaryReport.Append("<td align='left' valign='top'>");
                        myBuilderSummaryReport.Append(myRow[myColumn.ColumnName].ToString());
                        myBuilderSummaryReport.Append("</td>");
                    }
                    myBuilderSummaryReport.Append("</tr>");
                }
            ...
            myBuilderSummaryReport.Append("</table>");

            return myBuilderSummaryReport.ToString();
        }
        ...
        private void GlobalReport()
        {
            ...
            //Set DataTable Name which will be the name of Excel Sheet.
            EDIweeklyReport_dt.TableName = "EMSDB-EDI Weekly Report";
            EDIpendingReport_dt.TableName = "EMSDB-EDI Pending Report";
            EDISLA_dt.TableName = "EMSDB-EDI SLA Report";
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                using (MemoryStream memoryStream = new MemoryStream())
                {
                   ...
                   // message1.To.Add(("namohar.m@tangoe.com"));
                    ...
                    message1.Attachments.Add(new Attachment(new MemoryStream(bytes), "GlobalSupport EMS Invoice Processing EOB Report.xlsx"));
                    ...
                    //sb.AppendLine("");
                    sb.AppendLine(string.Format("<br /> Global Support EMS Manual Invoice Processing EOB Report  for : " + To.ToString("yyyy-MM-dd")));
                    sb.AppendLine("<br />");
                    sb.AppendLine("<br />");
                    sb.AppendLine("Pending/In Queue Volumes:");
                    sb.AppendLine("");
                    ...
                    sb.AppendLine("<br />");
                    sb.AppendLine("");
                    sb.AppendLine("********************* Global Support EMS Electronic Invoice Processing EOB Report. ****************************");
                    sb.AppendLine("<br />");
                    sb.AppendLine("<br />");
                    sb.AppendLine("<br />");
        ...
        private void EDIReport()
        {
            ...
            // dt = GetDataEDI(";with CTE_Input1 as ( select RecieveDate,cast(IND_IP_ModifiedOn as date) as ProcessDate, count(FI_OriginalName) as InvoiceCount from  (select cast(FI_CreatedOn as date ) as RecieveDate, IND_IP_ModifiedOn,FI_OriginalName from dbo.EMSDB_FileInfo  left join dbo.EMSDB_InvDetails on IND_FI=FI_ID   where cast(FI_CreatedOn as date ) >='" + From.ToString("yyyy-MM-dd") + "'  and cast(FI_CreatedOn as date ) <='" + To.ToString("yyyy-MM-dd") + "' and IND_IP_Processed_By !='null' and IND_Status not in ('IP_Asg','IP_Inp','IP_Issue')) A group by cast(IND_IP_ModifiedOn as date),RecieveDate),CTE_Input2 as (select cast(FI_CreatedOn as date )as RecieveDate, count(FI_OriginalName) as TotalInvoices from dbo.EMSDB_FileInfo   left join dbo.EMSDB_InvDetails on IND_FI=FI_ID  where cast(FI_CreatedOn as date ) >='" + From.ToString("yyyy-MM-dd") + "'  and cast(FI_CreatedOn as date ) <='" + To.ToString("yyyy-MM-dd") + "' group by cast(FI_CreatedOn as date )),CTE_Input3 as(SELECT RecieveDate,ProcessDate,TotalInvoices,InvoiceCount,Cast(round(Accuracy,2) as decimal(10,2)) as Day1 FROM (select CTE_Input1.RecieveDate as RecieveDate,CTE_Input1.ProcessDate as ProcessDate,CTE_Input1.InvoiceCount as InvoiceCount,CTE_Input2.TotalInvoices as TotalInvoices, case when CTE_Input1.InvoiceCount<>0 then (CAST(CTE_Input1.InvoiceCount as float)/CAST(CTE_Input2.TotalInvoices as float)*100.0) else 100 END as Accuracy from  CTE_Input1 join CTE_Input2 on CTE_Input1.RecieveDate=CTE_Input2.RecieveDate )B ) select * from CTE_Input3");
